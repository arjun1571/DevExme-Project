...
const Artical = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="lg:p-10 md:p-5 p-3 ">
          ...
          <div className="flex items-center">
            ...
            <div className="relative w-full mx-3 ">
              <select name="topic"
                ...
                className="md:w-48 w-32 p-2.5 rounded-md shadow-sm outline-none appearance-none focus:border-black"
              >
                {topics.map((topic) => (
        ...
        <div className="">
          <div className="flex items-center">
            ...
            <div className="relative w-full lg:max-w-sm mx-3">
              <select name="subtopic" className="md:w-48 w-32 p-2.5 rounded-md shadow-sm outline-none appearance-none focus:border-indigo-600">
      ...
      <div className="mt-5 lg:mx-60 md:mx-12">
        <p>Abstract</p>
        <div class=" py-3">
          <textarea name="abstract" class="resize rounded-md w-full md:py-10 py-7"></textarea>
        </div>
      </div>
      {/* <Quill></Quill> */}
      <div>
      ...
      <div className="mt-5 lg:mx-60 md:mx-12">
        ...
        <div class="md:w-3/4 py-3">
          <textarea name="embed" required class="resize rounded-md w-3/4 md:py-10 py-7"></textarea>
        </div>
      </div>
      <div className="mt-5 lg:mx-60 md:mx-12">
        <p>Upload Image:</p>
