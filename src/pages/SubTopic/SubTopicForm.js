...
const SubToicForm = () => {
  ...
  return (
    <form onSubmit={handleList} className="my-10">
     ...
     <div>
        <p className="my-2 mx-6 mt-5">SubTopic Name <span className="text-red-700 font-bold text-lg">*</span></p>
        <input
          required
          name="name"
          type="text"
      ...
      <div>
      <p className="my-2 mx-6 mt-5">Select Topic <span className="text-red-700 font-bold text-lg">*</span></p>
            <div className="mx-5">
      ...
      <div>
        <p className="my-2 mx-6 mt-5">Highlights <span className="text-red-700 font-bold text-lg">*</span></p>
        <input
          required
          name="highlight"
          type="text"
